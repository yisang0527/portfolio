...
<head>
    ...
    <style>
        ...
        * {
        ...
        .textSection2List p:nth-of-type(1) {
            left: 3.1%;
        }
    ...
    <script>
        $(function () {
            ...
            // 네비 토글
            $(".navBig1").on("click", function () {
                $(".navSmall1").toggle("show");
                $(".navSmall2").hide();
            });

            $(".navBig2").on("click", function () {
                $(".navSmall2").toggle("show");
                $(".navSmall1").hide();
            });
        ...
        <div class="siteList">
            ...
            <div class="siteText">
                ...
                <div class="textSection2">
                    ...
                    <div class="textList textSection2List">
                        <p>996</p>
                        <p>2025.09.16</p>
                        <div>
                            <!-- 최근게시글 스킨명, 호출할 게시판명, 게시글 수, 제목글 수-->
                            <?=latest('basic2','board',10,50); ?>
                        </div>
                        <p>105</p>
                    </div>
                    ...
                    <div class="textList textSection2List">
                        ...
                        <p>2025.09.12</p>
                        <p>26</p>
                        <img src="img/ic-down4.png" alt="다운로드 이미지">
                    </div>
                    ...
                    <div class="pageList">
                        <img src="img/pagebutton1.png" alt="페이지 이동 버튼 이미지">
                        <p>1 <span>2 </span><span>3 </span><span>4 </span><span>5 </span><span>6 </span><span>7 </span><span>8 </span><span>9 </span><span>10 </span></p>
                        <img src="img/pagebutton2.png" alt="페이지 이동 버튼 이미지">
                        <img src="img/pagebutton3.png" alt="페이지 이동 버튼 이미지">
                        <img src="img/pagebutton4.png" alt="페이지 이동 버튼 이미지">
                    </div>
                </div>
            </div>
