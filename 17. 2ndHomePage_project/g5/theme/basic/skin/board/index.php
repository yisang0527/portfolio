        ...
        $(function () {
            ...
            $(".list .small a").hover(
                function () {
                    ...
                    $bigLi.find("img").attr("src", "img/ap2.png");
                },
                function () {
                    const $bigLi = $(this).closest(".big > li");
                    ...
                    $bigLi.find("img").attr("src", "img/ap1.png");
                }
            );
            ...
            $(".navSmall1 li").hover(
                function () {
                    $(this).find("img").attr("src", "img/ap2.png");
                },
                function () {
                    $(this).find("img").attr("src", "img/ap1.png");
                }
            );
...
<body>
    <header>
        <div class="header1">
            ...
            <div class="uiButton">
                <button>
                    <p>KOR</p>
                    <img src="img/top-arrow.png" alt="토글 버튼">
                </button>
        ...
        <div class="header2">
            <div class="logo2">
                <a href="#"><img src="img/logo1.png" alt="로고 이미지"></a>
            </div>

            <ul>
                <li><a href="#">공사소개</a></li>
                <li><a href="http://yisang0527.dothome.co.kr/customer1.html">고객소통</a></li>
                <li><a href="http://yisang0527.dothome.co.kr/business1.html">업무지원</a></li>
                <li><a href="#">인재채용</a></li>
            </ul>

            <a href="http://yisang0527.dothome.co.kr/index.html">
            ...
            <div class="list list2">
                <div class="textArea">
                    ...
                    <div class="right">
                        <ul class="big">
                            <li><a href="http://yisang0527.dothome.co.kr/customer1.html">공지사항</a>
                                <img src="img/ap1.png" alt="비행기 이미지">
                                <p></p>
                            </li>

                            <li><a href="http://yisang0527.dothome.co.kr/customer2.html">보도자료</a>
                                <img src="img/ap1.png" alt="비행기 이미지">
                                <p></p>
                            </li>

                            <li><a href="http://yisang0527.dothome.co.kr/customer3.html">민원마당</a>
                                <img src="img/ap1.png" alt="비행기 이미지">
                                <p></p>
                                <ul class="small">
            ...
            <div class="list list3">
                <div class="textArea">
                    ...
                    <div class="right">
                        <ul class="big">
                            <li><a href="http://yisang0527.dothome.co.kr/business1.html">규정</a>
                                <img src="img/ap1.png" alt="비행기 이미지">
                                <p></p>
                            </li>
    ...
    <main>
        <div class="mainHeader">
            <img src="img/customerH.jpg" alt="고객소통 헤더 이미지">
        </div>
        ...
        <div class="siteList">
            ...
            <div class="siteNav">
                <a href="#"><img src="img/logo4.png" alt="로고 이미지"></a>
                ...
                <ul class="navBig1">
                    <li><a href="#">고객소통
                        ...
                        <ul class="navSmall1">
                            ...
                            <li><a href="http://yisang0527.dothome.co.kr/customer1.html">고객소통</a>
                                <img src="img/ap1.png" alt="비행기 이미지">
                            </li>
                            <li><a href="http://yisang0527.dothome.co.kr/business1.html">업무지원</a>
                                <img src="img/ap1.png" alt="비행기 이미지">
                            </li>
                            <li><a href="#">인재채용</a>
                                <img src="img/ap1.png" alt="비행기 이미지">
                            </li>
                            <li><a href="http://yisang0527.dothome.co.kr/index.html">기타</a>
                                <img src="img/ap1.png" alt="비행기 이미지">
                            </li>
                        </ul>
                    </li>
                ...
                <ul class="navBig2">
                    ...
                    <img src="img/nav1.png" alt="화살표">
                </ul>

                <div class="navBox">
                    <div class="navbox navBox1">
                        <img src="img/nav3.png" alt="box 이미지">
                    </div>
                    <div class="navbox navBox2">
                        <img src="img/nav4.png" alt="box 이미지">
                    </div>
                    <div class="navbox navBox3">
                        <img src="img/nav5.png" alt="box 이미지">
                    </div>
                </div>
            </div>
            ...
            <div class="siteText">
                ...
                <div class="textSection1">
                    ...
                    <ul class="textSection1Big">
                        <li><a href="#">제목
                                <img src="img/ic-arrow.png" alt="화살표 이미지">
                            </a>
                    ...
                    <div class="inputBox">
                        ...
                        <img src="img/ic-search.png" alt="돋보기 이미지">
                    </div>
                </div>
            ...
            <div class="survey">
                <div class="surveyTitle">
                    <img src="img/survey.png" alt="만족도조사">
                    <p>콘텐츠 만족도 조사</p>
                </div>
            ...
            <footer>
                ...
                <div class="footer2">
                    <div class="footerLogo">
                        <img src="img/footer-logo.png" alt="푸터 로고 이미지">
                    </div>
                    ...
                    <div class="footerInpor">
                        <div class="footerSns">
                            <img src="img/web.png" alt="웹표준 이미지">
                            <img src="img/sns1.png" alt="sns 이미지">
                            <img src="img/sns2.png" alt="sns 이미지">
                            <img src="img/sns3.png" alt="sns 이미지">
                            <img src="img/sns4.png" alt="sns 이미지">
    ...
    <div class="toTop">
        <button>
            <img src="img/btnTop.png" alt="top버튼">
        </button>
    </div>
</body>
