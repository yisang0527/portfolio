...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .action-btns button { padding: 10px 20px; margin-left: 10px; border: none; border-radius: 30px; cursor: pointer;
    font-size: 16px; }
    ...
    .sort-btn.active::after { content: none; }

    /* 갤러리 */
    #gal1 { display: flex; flex-wrap: wrap; gap: 10px; max-width: 1500px; margin: 20px auto; justify-content: center;
    ...
    #gal1 .ima img { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 60%;
    height: auto; max-height: 100%; }
    #gal1 h2 { font-size: 18px; margin: 10px 0; white-space: wrap; letter-spacing: -0.5px; }
    #gal1 p { border: 1px solid #222; border-radius: 5px; width: 40px; font-size: 15px; font-weight: bold;
    padding: 0 5px; font-family: sans-serif; }
...
<body>
  ...
  <div id="cont">
    ...
    <div id="gal1">
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page1">
          <div class="ima"><img src="img/1/11.jpg" alt=""></div>
          <h2>머리에 콕 입에 착 붙는 어휘 스도쿠_고사성어</h2>
          <p>국어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page2">
          <div class="ima"><img src="img/1/12.jpg" alt=""></div>
          <h2>머리에 콕 입에 착 붙는 어휘 스도쿠_속담</h2>
          <p>국어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page3">
          <div class="ima"><img src="img/1/13.jpg" alt=""></div>
          <h2>1일 1독해 우리나라 ➍ 보물</h2>
          <p>국어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page4">
          <div class="ima"><img src="img/1/14.jpg" alt=""></div>
          <h2>1일 1독해 우리나라 ➌ 우리 문화</h2>
          <p>국어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page5">
          <div class="ima"><img src="img/1/15.jpg" alt=""></div>
          <h2>1일 1독해 우리나라 ➋ 속담</h2>
          <p>국어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page6">
          <div class="ima"><img src="img/1/16.jpg" alt=""></div>
          <h2>1일 1독해 우리나라 ➊ 전래동화</h2>
          <p>국어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page7">
          <div class="ima"><img src="img/1/17.jpg" alt=""></div>
          <h2>백점백승 구조 독해 초등 과학 4학년</h2>
          <p>과학</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page8">
          <div class="ima"><img src="img/1/18.jpg" alt=""></div>
