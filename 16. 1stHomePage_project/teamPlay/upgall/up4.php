...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* 필터 */
    #filterall { margin-top: 30px; padding: 10px 20px; border: 1px solid #ccc;border-radius: 20px;
    background: #fafafa; }
    .filter-box { margin-bottom: 20px; }
    .filter-title { margin-bottom: 10px; font-weight: bold; }
    .filter-btns { display: flex; flex-wrap: wrap; gap: 5px; padding-right: 400px; }
    .filter-btn { min-width: 100px; height: 40px; padding: 8px 5px; border: 1px solid #ccc; border-radius: 5px;
    background: #fff; font-size: 16px; font-weight: 600; text-align: center; cursor: pointer; transition: 0.2s; }
    ...
    .sort-tabs { display: flex; gap: 15px; padding-bottom: 20px; border-bottom: 2px solid #111; }
    .sort-btn { border: none; background: none; font-size: 16px; color: #777; cursor: pointer; position: relative; }
    .sort-btn.active { font-weight: bold; color: #000; }
    .sort-btn.active::after { content: none; position: absolute; bottom: -5px; left: 0; right: 0; 
    ...
    #gal1 .ima img { position: absolute; top: 50%; left: 50%; width: 60%; height: auto; max-height: 100%;
    transform: translate(-50%, -50%); }
    #gal1 h2 { margin: 10px 0; font-size: 18px; letter-spacing: -0.5px; white-space: wrap; }
    #gal1 p { display: inline-block; padding: 0 5px; border: 1px solid #222; border-radius: 5px; font-size: 15px;
  ...
  $(function () {
    ...
    $('.btn-reset').click(function () {
      ...
      firstBox.find('.filter-btn').removeClass('active').eq(4).addClass('active'); // 초등
...
<body>
  ...
  <div id="cont">
    ...
    <div id="gal1">
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page41">
      ...
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page42">
      ...
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page43">
      ...
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page44">
      ...
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page45">
      ...
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page46">
      ...
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page47">
      ...
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page48">
