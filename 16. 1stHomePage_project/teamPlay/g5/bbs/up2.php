...
<head>
  ...
  <style>
    * {margin:0; padding:0; box-sizing:border-box;}
    ...
    #gal1 h2 {font-size: 18px; margin: 10px 0; white-space: nowrap; letter-spacing: -0.5px;}
  ...
  <script>
    $(document).ready(function () {
      ...
      $('.btn-reset').on('click', function () {
        ...
        $('.filter-box').eq(0).find('.filter-btn').eq(2).addClass('active');  // "초등" 버튼 선택
...
<body>
  <div id="cont">
    ...
    <div id="gal1">
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=gallery&wr_id=13">
          <div class="ima"><img src="img/2/21.jpg"></div>
          <h2>완쏠 개념연산 중등수학 3-1(2027년)</h2>
          <p>수학</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=gallery&wr_id=12">
          <div class="ima"><img src="img/2/22.jpg"></div>
          <h2>수학숙제 중등 3-1 (2027년)</h2>
          <p>수학</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=gallery&wr_id=11">
          <div class="ima"><img src="img/2/23.jpg"></div>
          <h2>구해영 중학 영어 독해 Level 4</h2>
          <p>영어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=gallery&wr_id=10">
          <div class="ima"><img src="img/2/24.jpg"></div>
          <h2>구해영 중학 영어 독해 Level 3</h2>
          <p>영어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=gallery&wr_id=9">
          <div class="ima"><img src="img/2/25.jpg"></div>
          <h2>구해영 중학 영어 독해 Level 2</h2>
          <p>영어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=gallery&wr_id=8">
          <div class="ima"><img src="img/2/26.jpg"></div>
          <h2>구해영 중학 영어 독해 Level 1</h2>
          <p>영어</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=gallery&wr_id=7">
          <div class="ima"><img src="img/2/27.jpg"></div>
          <h2>완쏠 개념 중등수학 3-1 (2027년)</h2>
          <p>수학</p>
        </a>
      </div>
      <div class="book">
        <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=gallery&wr_id=6">
          <div class="ima"><img src="img/2/28.jpg"></div>
