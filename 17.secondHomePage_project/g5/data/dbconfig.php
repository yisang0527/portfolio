...
define('G5_MYSQL_USER', 'yisang0527');
define('G5_MYSQL_PASSWORD', 'pokedex576!!');
define('G5_MYSQL_DB', 'yisang0527');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '9104540ea72386602528280b8e5521e3'); // 토큰 암호화에 사용할 키
